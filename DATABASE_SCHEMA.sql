...
INSERT INTO public.global_settings (key, value, description) VALUES
  ...
  ('seo_gsc_verification',     '',                                                                                                                        'GSC verification ID'),
  ('seo_gtm_container_id',     'GTM-KPKFPCXM',                                                                                                           'GTM container ID'),
  ('seo_h1',                   'Same-Day River Sand Delivery in New Orleans',                                                                              'Homepage H1 tag'),
  ('seo_homepage_description', 'Order river sand delivery in New Orleans today. Same-day dispatch, 9 cubic yards, instant online pricing.',                'Homepage meta description'),
  ('seo_homepage_h1',          'Same-Day River Sand Delivery in New Orleans',                                                                              'Homepage H1 tag'),
  ('seo_homepage_title',       'Same-Day River Sand Delivery | New Orleans, LA | River Sand',                                                              'Homepage meta title'),
