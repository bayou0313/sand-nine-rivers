...
CREATE POLICY "service_manage_customers" ON public.customers
...
-- Step 3: Update create_order RPC with customer upsert
...
BEGIN
  ...
  -- Upsert customer record (only if email provided)
