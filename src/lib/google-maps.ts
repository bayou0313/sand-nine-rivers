 ...
 */
const GOOGLE_MAPS_API_KEY = import.meta.env.VITE_GOOGLE_MAPS_KEY || "AIzaSyAsMj_79RhJREIAaVBNvSPN3nYefLic-WY";
...
export function loadGoogleMaps(): Promise<void> {
  ...
  loadPromise = new Promise<void>((resolve) => {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=${GOOGLE_MAPS_API_KEY}&libraries=places,marker&loading=async&v=weekly`;
    script.async = true;
    script.defer = true;
