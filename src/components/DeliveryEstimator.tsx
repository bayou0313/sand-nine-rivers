        ...
        {result && (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button variant="outline" className={`flex-1 h-12 font-display tracking-wider text-lg rounded-xl border-2 border-accent text-accent bg-transparent hover:bg-accent/10`} asChild>
