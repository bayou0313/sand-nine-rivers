      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          <div className="flex flex-col justify-start">
            <img src={logoImg} alt="RiverSand logo" className="w-[200px] h-auto object-contain mb-4 brightness-0 invert self-start -mt-[100px]" loading="lazy" />
            <p className="font-body text-background/40 text-sm leading-relaxed -mt-[70px]">
