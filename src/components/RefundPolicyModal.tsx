    ...
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4 font-body text-sm text-muted-foreground">
          ...
          <p>If you need help or have questions, please call us at <p>If you need help or have questions, please call us at <a href="tel:+18554689297" className="text-accent underline font-medium whitespace-nowrap">1-855-GOT-WAYS</a> — our team is here to help.</p> — our team is here to help.</p>
